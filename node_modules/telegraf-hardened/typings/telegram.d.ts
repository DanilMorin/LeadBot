...
export declare class Telegram extends ApiClient {
    ...
    setGameScore(userId: number, score: number, inlineMessageId: string | undefined, chatId: number | undefined, messageId: number | undefined, editMessage?: boolean, force?: boolean): Promise<true | (tg.Update.Edited & tg.Message.GameMessage & tg.Message.BusinessSentMessage)>;
    /**
     ...
     */
    sendMessage(chatId: number | string, text: string | FmtString, extra?: tt.ExtraReplyMessage): Promise<tg.Message.TextMessage & tg.Message.BusinessSentMessage>;
    /**
     ...
     */
    forwardMessage(chatId: number | string, fromChatId: number | string, messageId: number, extra?: tt.ExtraForwardMessage): Promise<tg.Message & tg.Message.BusinessSentMessage>;
    /**
     ...
     * @param chatId Unique identifier for the target chat or username of the target channel (in the format @channelusername)
     */
    sendLocation(chatId: number | string, latitude: number, longitude: number, extra?: tt.ExtraLocation): Promise<tg.Message.LocationMessage & tg.Message.BusinessSentMessage>;
    sendVenue(chatId: number | string, latitude: number, longitude: number, title: string, address: string, extra?: tt.ExtraVenue): Promise<tg.Message.VenueMessage & tg.Message.BusinessSentMessage>;
    /**
     * @param chatId Unique identifier for the target private chat
     */
    sendInvoice(chatId: number | string, invoice: tt.NewInvoiceParameters, extra?: tt.ExtraInvoice): Promise<tg.Message.InvoiceMessage & tg.Message.BusinessSentMessage>;
    sendContact(chatId: number | string, phoneNumber: string, firstName: string, extra?: tt.ExtraContact): Promise<tg.Message.ContactMessage & tg.Message.BusinessSentMessage>;
    /**
     * @param chatId Unique identifier for the target chat or username of the target channel (in the format @channelusername)
     */
    sendPhoto(chatId: number | string, photo: tg.Opts<'sendPhoto'>['photo'], extra?: tt.ExtraPhoto): Promise<tg.Message.PhotoMessage & tg.Message.BusinessSentMessage>;
    /**
     * Send a dice, which will have a random value from 1 to 6.
     * @param chatId Unique identifier for the target chat or username of the target channel (in the format @channelusername)
     */
    sendDice(chatId: number | string, extra?: tt.ExtraDice): Promise<tg.Message.DiceMessage & tg.Message.BusinessSentMessage>;
    /**
     ...
     * @param chatId Unique identifier for the target chat or username of the target channel (in the format @channelusername)
     */
    sendDocument(chatId: number | string, document: tg.Opts<'sendDocument'>['document'], extra?: tt.ExtraDocument): Promise<tg.Message.DocumentMessage & tg.Message.BusinessSentMessage>;
    /**
     ...
     * @param chatId Unique identifier for the target chat or username of the target channel (in the format @channelusername)
     */
    sendAudio(chatId: number | string, audio: tg.Opts<'sendAudio'>['audio'], extra?: tt.ExtraAudio): Promise<tg.Message.AudioMessage & tg.Message.BusinessSentMessage>;
    /**
     * Send .webp, animated .tgs, or video .webm stickers
     * @param chatId Unique identifier for the target chat or username of the target channel (in the format @channelusername)
     */
    sendSticker(chatId: number | string, sticker: tg.Opts<'sendSticker'>['sticker'], extra?: tt.ExtraSticker): Promise<tg.Message.StickerMessage & tg.Message.BusinessSentMessage>;
    /**
     * Send video files, Telegram clients support mp4 videos (other formats may be sent as Document).
     * Bots can currently send video files of up to 50 MB in size, this limit may be changed in the future.
     * @param chatId Unique identifier for the target chat or username of the target channel (in the format @channelusername)
     */
    sendVideo(chatId: number | string, video: tg.Opts<'sendVideo'>['video'], extra?: tt.ExtraVideo): Promise<tg.Message.VideoMessage & tg.Message.BusinessSentMessage>;
    /**
     * Send .gif animations.
     * @param chatId Unique identifier for the target chat or username of the target channel (in the format @channelusername)
     */
    sendAnimation(chatId: number | string, animation: tg.Opts<'sendAnimation'>['animation'], extra?: tt.ExtraAnimation): Promise<tg.Message.AnimationMessage & tg.Message.BusinessSentMessage>;
    /**
     * Send video messages.
     * @param chatId Unique identifier for the target chat or username of the target channel (in the format @channelusername)
     */
    sendVideoNote(chatId: number | string, videoNote: string | tg.InputFileVideoNote, extra?: tt.ExtraVideoNote): Promise<tg.Message.VideoNoteMessage & tg.Message.BusinessSentMessage>;
    /**
     * Send audio files, if you want Telegram clients to display the file as a playable voice message. For this to work, your audio must be in an .ogg file encoded with OPUS (other formats may be sent as Audio or Document). On success, the sent Message is returned. Bots can currently send voice messages of up to 50 MB in size, this limit may be changed in the future.
     * @param chatId Unique identifier for the target chat or username of the target channel (in the format @channelusername)
     */
    sendVoice(chatId: number | string, voice: tg.Opts<'sendVoice'>['voice'], extra?: tt.ExtraVoice): Promise<tg.Message.VoiceMessage & tg.Message.BusinessSentMessage>;
    /**
     ...
     */
    sendPaidMedia(chatId: number | string, media: tg.Opts<'sendPaidMedia'>['media'], starCount: number, extra?: tt.ExtraPaidMedia): Promise<tg.Message.PaidMediaMessage & tg.Message.BusinessSentMessage>;
    /**
     * @param chatId Unique identifier for the target chat
     * @param gameShortName Short name of the game, serves as the unique identifier for the game. Set up your games via Botfather.
     */
    sendGame(chatId: number, gameName: string, extra?: tt.ExtraGame): Promise<tg.Message.GameMessage & tg.Message.BusinessSentMessage>;
    /**
     * Send a group of photos or videos as an album.
     * @param chatId Unique identifier for the target chat or username of the target channel (in the format @channelusername)
     * @param media A JSON-serialized array describing photos and videos to be sent, must include 2–10 items
     */
    sendMediaGroup(chatId: number | string, media: tt.MediaGroup, extra?: tt.ExtraMediaGroup): Promise<((tg.Message.DocumentMessage | tg.Message.AudioMessage | tg.Message.PhotoMessage | tg.Message.VideoMessage) & tg.Message.BusinessSentMessage)[]>;
    /**
     * Send a native poll.
     * @param chatId Unique identifier for the target chat or username of the target channel (in the format @channelusername)
     ...
     */
    sendPoll(chatId: number | string, question: string, options: readonly string[], extra?: tt.ExtraPoll): Promise<tg.Message.PollMessage & tg.Message.BusinessSentMessage>;
    /**
     * Send a native quiz.
     * @param chatId Unique identifier for the target chat or username of the target channel (in the format @channelusername)
     * @param question Poll question, 1-255 characters
     * @param options A JSON-serialized list of answer options, 2-10 strings 1-100 characters each
     */
    sendQuiz(chatId: number | string, question: string, options: readonly string[], extra?: tt.ExtraPoll): Promise<tg.Message.PollMessage & tg.Message.BusinessSentMessage>;
    /**
     * @param chatId Unique identifier for the target chat or username of the target channel (in the format @channelusername)
     ...
     */
    getChat(chatId: number | string): Promise<tg.ChatFullInfo>;
    /**
     * @param chatId Unique identifier for the target chat or username of the target supergroup or channel (in the format @channelusername)
     */
    ...
    answerCallbackQuery(args: tg.Opts<'answerCallbackQuery'>): Promise<true>;
     ...
     */
    editMessageText(chatId: number | string | undefined, messageId: number | undefined, inlineMessageId: string | undefined, text: string | FmtString, extra?: tt.ExtraEditMessageText): Promise<true>;
    /**
     ...
     */
    editMessageCaption(chatId: number | string | undefined, messageId: number | undefined, inlineMessageId: string | undefined, caption: string | FmtString | undefined, extra?: tt.ExtraEditMessageCaption): Promise<true | (tg.Update.Edited & tg.Message.CaptionableMessage & tg.Message.BusinessSentMessage)>;
    /**
     ...
     */
    editMessageMedia(chatId: number | string | undefined, messageId: number | undefined, inlineMessageId: string | undefined, media: tt.WrapCaption<tg.InputMedia>, extra?: tt.ExtraEditMessageMedia): Promise<true | (tg.Update.Edited & tg.Message & tg.Message.BusinessSentMessage)>;
    /**
     ...
     */
    editMessageReplyMarkup(chatId: number | string | undefined, messageId: number | undefined, inlineMessageId: string | undefined, markup: tg.InlineKeyboardMarkup | undefined): Promise<true | (tg.Update.Edited & tg.Message & tg.Message.BusinessSentMessage)>;
    editMessageLiveLocation(chatId: number | string | undefined, messageId: number | undefined, inlineMessageId: string | undefined, latitude: number, longitude: number, extra?: tt.ExtraEditMessageLiveLocation): Promise<true | (tg.Update.Edited & tg.Message.LocationMessage & tg.Message.BusinessSentMessage)>;
    stopMessageLiveLocation(chatId: number | string | undefined, messageId: number | undefined, inlineMessageId: string | undefined, markup?: tg.InlineKeyboardMarkup): Promise<true | (tg.Update.Edited & tg.Message.LocationMessage & tg.Message.BusinessSentMessage)>;
    /**
     ...
     */
    get setStickerSetThumb(): (name: string, userId: number, thumbnail: string | tg.InputFile | undefined, format: "video" | "static" | "animated") => Promise<true>;
    /**
     ...
     */
    setStickerSetThumbnail(name: string, userId: number, thumbnail: tg.Opts<'setStickerSetThumbnail'>['thumbnail'] | undefined, format: tg.Opts<'setStickerSetThumbnail'>['format']): Promise<true>;
     ...
     */
    getStarTransactions(offset?: number, limit?: number): Promise<tg.StarTransactions>;
    /**
     * Refunds a successful payment in Telegram Stars.
     * @returns true on success
     */
    refundStarPayment(userId: number, telegramPaymentChargeId: string): Promise<true>;
    getBusinessConnection(business_connection_id: string): Promise<tg.BusinessConnection>;
    sendChecklist(args: tg.Opts<'sendChecklist'>): Promise<tg.Message.ChecklistMessage & tg.Message.BusinessSentMessage>;
    sendMessageDraft(args: tg.Opts<'sendMessageDraft'>): Promise<true>;
    getUserProfileAudios(args: tg.Opts<'getUserProfileAudios'>): Promise<tg.UserProfileAudios>;
    setUserEmojiStatus(args: tg.Opts<'setUserEmojiStatus'>): Promise<true>;
    setChatMemberTag(args: tg.Opts<'setChatMemberTag'>): Promise<true>;
    createChatSubscriptionInviteLink(args: tg.Opts<'createChatSubscriptionInviteLink'>): Promise<tg.ChatInviteLink>;
    editChatSubscriptionInviteLink(args: tg.Opts<'editChatSubscriptionInviteLink'>): Promise<tg.ChatInviteLink>;
    getManagedBotToken(args: tg.Opts<'getManagedBotToken'>): Promise<string>;
    replaceManagedBotToken(args: tg.Opts<'replaceManagedBotToken'>): Promise<string>;
    setMyProfilePhoto(args: tg.Opts<'setMyProfilePhoto'>): Promise<true>;
    removeMyProfilePhoto(args: tg.Opts<'removeMyProfilePhoto'>): Promise<true>;
    getAvailableGifts(): Promise<tg.Gifts>;
    sendGift(args: tg.Opts<'sendGift'>): Promise<true>;
    giftPremiumSubscription(args: tg.Opts<'giftPremiumSubscription'>): Promise<true>;
    verifyUser(args: tg.Opts<'verifyUser'>): Promise<true>;
    verifyChat(args: tg.Opts<'verifyChat'>): Promise<true>;
    removeUserVerification(args: tg.Opts<'removeUserVerification'>): Promise<true>;
    removeChatVerification(args: tg.Opts<'removeChatVerification'>): Promise<true>;
    readBusinessMessage(args: tg.Opts<'readBusinessMessage'>): Promise<true>;
    deleteBusinessMessages(args: tg.Opts<'deleteBusinessMessages'>): Promise<true>;
    setBusinessAccountName(args: tg.Opts<'setBusinessAccountName'>): Promise<true>;
    setBusinessAccountUsername(args: tg.Opts<'setBusinessAccountUsername'>): Promise<true>;
    setBusinessAccountBio(args: tg.Opts<'setBusinessAccountBio'>): Promise<true>;
    setBusinessAccountProfilePhoto(args: tg.Opts<'setBusinessAccountProfilePhoto'>): Promise<true>;
    removeBusinessAccountProfilePhoto(args: tg.Opts<'removeBusinessAccountProfilePhoto'>): Promise<true>;
    setBusinessAccountGiftSettings(args: tg.Opts<'setBusinessAccountGiftSettings'>): Promise<true>;
    getBusinessAccountStarBalance(args: tg.Opts<'getBusinessAccountStarBalance'>): Promise<tg.StarAmount>;
    transferBusinessAccountStars(args: tg.Opts<'transferBusinessAccountStars'>): Promise<true>;
    getBusinessAccountGifts(args: tg.Opts<'getBusinessAccountGifts'>): Promise<tg.OwnedGifts>;
    getUserGifts(args: tg.Opts<'getUserGifts'>): Promise<tg.OwnedGifts>;
    getChatGifts(args: tg.Opts<'getChatGifts'>): Promise<tg.OwnedGifts>;
    convertGiftToStars(args: tg.Opts<'convertGiftToStars'>): Promise<true>;
    upgradeGift(args: tg.Opts<'upgradeGift'>): Promise<true>;
    transferGift(args: tg.Opts<'transferGift'>): Promise<true>;
    postStory(args: tg.Opts<'postStory'>): Promise<tg.Story>;
    repostStory(args: tg.Opts<'repostStory'>): Promise<tg.Story>;
    editStory(args: tg.Opts<'editStory'>): Promise<tg.Story>;
    deleteStory(args: tg.Opts<'deleteStory'>): Promise<true>;
    savePreparedInlineMessage(args: tg.Opts<'savePreparedInlineMessage'>): Promise<tg.PreparedInlineMessage>;
    savePreparedKeyboardButton(args: tg.Opts<'savePreparedKeyboardButton'>): Promise<tg.PreparedKeyboardButton>;
    editMessageChecklist(args: tg.Opts<'editMessageChecklist'>): Promise<tg.Update.Edited & tg.Message.ChecklistMessage & tg.Message.BusinessSentMessage>;
    approveSuggestedPost(args: tg.Opts<'approveSuggestedPost'>): Promise<true>;
    declineSuggestedPost(args: tg.Opts<'declineSuggestedPost'>): Promise<true>;
    replaceStickerInSet(args: tg.Opts<'replaceStickerInSet'>): Promise<true>;
    getMyStarBalance(): Promise<tg.StarAmount>;
    editUserStarSubscription(args: tg.Opts<'editUserStarSubscription'>): Promise<true>;
    /**
