...
export declare function text(text: string, hide?: boolean): Hideable<KeyboardButton.Common>;
...
/** Must fit in a signed 32 bit int */
request_id: number, extra?: KeyboardButtonRequestChat, hide?: boolean): Hideable<KeyboardButton.RequestChat>;
