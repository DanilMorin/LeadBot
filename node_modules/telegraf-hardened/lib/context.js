...
class Context {
    ...
    get bizConnId() {
        return getBizConnIdFromAnySource(this);
    }
    get chat() {
        return (this.msg ??
...
function getBizConnIdFromAnySource(ctx) {
    if (ctx.businessConnection)
        return ctx.businessConnection.id;
    if (ctx.businessMessage)
        return ctx.businessMessage.business_connection_id;
