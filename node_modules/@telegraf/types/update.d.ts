...
import type { BusinessConnection, BusinessMessagesDeleted, Chat, ChatBoostRemoved, ChatBoostUpdated, ChatJoinRequest, ChatMemberUpdated, ManagedBotUpdated, MessageReactionCountUpdated, MessageReactionUpdated, User } from "./manage.js";
...
export declare namespace Update {
    ...
    interface BusinessConnectionUpdate extends AbstractUpdate {
        /** The bot was connected to or disconnected from a business account, or a user edited an existing connection with the bot */
        business_connection: BusinessConnection;
    }
    interface BusinessMessageUpdate<M extends CommonMessageBundle = CommonMessageBundle> extends AbstractUpdate {
        /** New message from a connected business account */
        business_message: New & NonChannel & Biz & M;
    }
    interface EditedBusinessMessageUpdate<M extends CommonMessageBundle = CommonMessageBundle> extends AbstractUpdate {
        /** New version of a message from a connected business account */
        edited_business_message: Edited & NonChannel & Biz & M;
    }
    interface DeletedBusinessMessagesUpdate extends AbstractUpdate {
    ...
    interface PurchasedPaidMediaUpdate extends AbstractUpdate {
    ...
    interface ManagedBotUpdate extends AbstractUpdate {
