import type { Chat, ChatOwnerChanged, ChatOwnerLeft, DirectMessagesTopic, File, Gift, ManagedBotCreated, StarAmount, SuggestedPostInfo, SuggestedPostPrice, UniqueGift, User } from "./manage.js";
...
export declare namespace Message {
    ...
    interface ManagedBotCreatedMessage extends ServiceMessage {
    ...
    interface PollOptionAddedMessage extends ServiceMessage {
        /** Service message: an option was added to a poll */
        poll_option_added: PollOptionAdded;
    }
    interface PollOptionDeletedMessage extends ServiceMessage {
...
export declare namespace MessageEntity {
    ...
    interface DateTime extends Abstract {
        type: "date_time";
...
export interface InputChecklistTask {
    ...
    text_entities?: (MessageEntity.Bold | MessageEntity.Italic | MessageEntity.Underline | MessageEntity.Strikethrough | MessageEntity.Spoiler | MessageEntity.CustomEmoji | MessageEntity.DateTime)[];
}
...
export interface InputChecklist {
    ...
    title_entities?: (MessageEntity.Bold | MessageEntity.Italic | MessageEntity.Underline | MessageEntity.Strikethrough | MessageEntity.Spoiler | MessageEntity.CustomEmoji | MessageEntity.DateTime)[];
