...
import type { AcceptedGiftTypes, BotCommand, BusinessConnection, ChatAdministratorRights, ChatFullInfo, ChatInviteLink, ChatMember, ChatMemberAdministrator, ChatMemberOwner, ChatPermissions, File, ForumTopic, Gifts, OwnedGifts, ReactionType, StarAmount, StoryArea, SuggestedPostParameters, UserChatBoosts, UserFromGetMe, UserProfileAudios, UserProfilePhotos, WebhookInfo } from "./manage.js";
import type { GameHighScore, InputChecklist, LinkPreviewOptions, MaskPosition, Message, MessageEntity, MessageId, ParseMode, Poll, PreparedInlineMessage, ReplyParameters, SentWebAppMessage, Sticker, StickerSet, Story } from "./message.js";
...
import { InputPollOption } from "./message.js";
...
export type ApiMethods<F> = {
    ...
    sendMediaGroup(args: {
        ...
        /** Description of the message to reply to */
        reply_parameters?: ReplyParameters;
    }): Array<(Message.AudioMessage | Message.DocumentMessage | Message.PhotoMessage | Message.VideoMessage) & Message.BusinessSentMessage>;
    ...
    }): Update.Edited & (Message.TextMessage | Message.GameMessage) & Message.BusinessSentMessage;
